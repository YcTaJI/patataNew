...
try {
    ...
    $mail->Password   = 'oservdzshpxdubty'; // Пароль на почте
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('kramskoy.va@yandex.ru', 'Сайт PaTaTa Club'); // Адрес самой почты и имя отправителя

    // Получатель письма
    $mail->addAddress('kirillnik92@mail.ru');
